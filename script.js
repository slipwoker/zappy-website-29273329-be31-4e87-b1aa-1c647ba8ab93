...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function handleFormSubmit(e) {
    ...
    if (isValid) {
      ...
      messageElement.textContent = form.getAttribute('data-success-message') || 'Form submitted successfully!';
      form.reset();
      fields.forEach(function(field) {
        field.classList.remove('form-input-error');
      });
      ...
      messageElement.textContent = form.getAttribute('data-error-message') || 'Please fix the errors above.';
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '29273329-be31-4e87-b1aa-1c647ba8ab93',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '29273329-be31-4e87-b1aa-1c647ba8ab93';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '29273329-be31-4e87-b1aa-1c647ba8ab93';
